...
import quaternary.botaniatweaks.compat.botania.lexi.PageCustomTerrasteel;
...
public class CTAgglomerationPage {
	...
	public static void add(String unlocalizedName, String entry, int pageNumber, CTAgglomeration.CTAgglomerationRecipe recipe) {
		CTHandler.ADD_ACTIONS.add(new AddAction(unlocalizedName, entry, pageNumber, recipe.toAgglomerationRecipe()));
	}
	...
	public static void add(String unlocalizedName, String entry, int pageNumber,
		...
		CTHandler.ADD_ACTIONS.add(new AddAction(unlocalizedName, entry, pageNumber, CTAgglomeration.buildAgglomerationRecipe(output, inputs, manaCostIn, color1In, color2In, center, edge, corner, centerReplace, edgeReplace, cornerReplace)));
	}
