...
public class ModuleJei implements IModule {
	...
	public void readConfig(Configuration config) {
		...
		FIX_CORPOREA_REQUEST_KEYBIND = config.getBoolean("fixCorporeaRequestKeybind", "jei", true, "If \"true\", you will be able to use the \"Corporea Request\" keybind to click on JEI bookmarks. (This is on by default, unlike basically everything else in the mod, because it doesn't hurt.)");
	}
}
